...
_server.get('/retoibm/sumar/:sumando1/:sumando2', function(request, response) {
  try{
    var _sumando01 = new Number(request.params.sumando1);
    var _sumando02 = new Number(request.params.sumando2);
